...
4. Take note of the exposed port and the worker node IP address.
...
5. Use curl to make an HTTP request specifying the IP address and port of the worker node.
...
6. Try to use the IP address of the control-plane node. What do you expect?
